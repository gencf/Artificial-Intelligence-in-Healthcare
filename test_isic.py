...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_path', type=str, default='/content/drive/MyDrive/İNAN/SağlıktaYapayZeka/TransFuse/new_dataset/ISKEMI/TransFuse_ISKEMI_'+str(n)+'_Epoch.pth')
