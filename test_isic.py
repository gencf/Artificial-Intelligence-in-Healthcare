...
if __name__ == '__main__':
    ...
    parser.add_argument('--png_path', type=str, default='/kaggle/working/new_dataset/KANAMA/test/MASKS')
    opt = parser.parse_args()

    ckpt_path = os.path.join(opt.model_path, 'TransFuse_KANAMA_' + str(opt.epoch) + '_Epoch_best.pth')
